<template>
    <div class="page-sidebar">
        <div class="logo-box"><a href="#" class="logo-text">Senior - LMS</a><a href="#" id="sidebar-close"><i
        ...
        <div class="page-sidebar-inner slimscroll">
            <ul class="accordion-menu">
                ...
                <router-link tag="li" to="/"><a><i class="material-icons-outlined">dashboard</i>Dashboard</a>
                </router-link>
                <router-link v-if="user.role == 'student'" tag="li" to="/course-registration"><a><i class="material-icons-outlined">library_add</i>Course Registration</a>
                </router-link>
                <router-link v-if="user.role == 'admin'" tag="li" to="/admin/user-manager"><a><i class="material-icons-outlined">supervisor_account</i>User Manager</a>
                </router-link>
                ...
                <router-link v-if="user.role == 'admin'" tag="li" to="/admin/registration-manager"><a><i class="material-icons-outlined">schedule</i>Registration Manager</a>
                </router-link>
                <router-link v-if="user.role == 'instructor'" tag="li" to="/my-requests"><a><i class="material-icons-outlined">task</i>My Requests</a>
                </router-link>
                <router-link v-if="user.role == 'student'" tag="li" to="/my-grades"><a><i class="material-icons-outlined">grade</i>My Grades</a>
                </router-link>
