            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div v-if="assignment.deadline"><strong>Assignment is due:</strong> <span
                        :class="parseDate(assignment.deadline) ? 'text-success' : 'text-danger'">{{ assignment.deadline | formatDate }}</span>
                    </div>
                    ...
                    <button class="btn btn-danger btn-md mt-3" data-toggle="modal"
                ...
                <div class="card-body w-50">
                    ...
                    <div class="col-md-12 p-0">
                        <div v-for="submission in all_submissions" v-if="submission.user_id == user.id">
                            ...
                            <button data-toggle="modal" data-target="#DeleteModal" @click="deleteHelper(submission.id)"
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card" v-for="(submission, index) in all_submissions">
                            <div class="card-header" :id="'heading' + index" data-toggle="collapse"
                                ...
                                :class="parseSubmission(submission.created_at) ? 'text-success' : 'text-danger'">(Submitted at {{ submission.created_at | formatDate }})</span>
...
export default {
    ...
    methods: {
        ...
        parseSubmission(date) {
            return moment(this.assignment.deadline).format('MMMM Do, h:mm a') > moment(date).format('MMMM Do, h:mm a');
        },
